...
<body>
	<div id="header">
		<div id="top-menu">
			<a href="{$BASE_URL}user/change_password" title="My account">My account</a> 
			<!--<a href="#" title="Settings">Settings</a>-->
			
			<span>Logged in as <a href="{$BASE_URL}user/change_password" 
            title="Logged in as {$user_profiles['username']}">{$user_profiles['username']}</a></span>
            
			| <a href="{$BASE_URL}auth/logout" title="Logout">Logout</a>
		</div>
        
		<div id="sitename">
			<a href="{$BASE_URL}home" title="POLYTRON"><img src="{$PATH_DIR_IMG}logo.png" /></a>
		...
		<ul id="navigation" class="sf-navbar">
            ...
            <li>
				...
				<ul>
					<li>
						<a href="{$BASE_URL}polytron/report/ticket">Ticket</a>
					</li>
					<li>
						<a href="{$BASE_URL}polytron/report/calls">Calls</a>
					</li>
				</ul>
			</li>
            -->
