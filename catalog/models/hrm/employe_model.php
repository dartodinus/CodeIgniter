...
class Employe_model extends CI_Model{
	...
	private $_table_other4	= 't_npwp';
	
    public function __construct() {
        parent::__construct();
    }
    
	public function get_karyawan_perpage($page,$where_clausa=NULL) {
		
		$p = ($page - 1) * 20;
		$sql	 = '';
		$sql 	.= 'SELECT  a.*,
						    b.divisi_id, b.nama_divisi,
						    c.jabatan_id, c.jabatan,
						    d.status_karyawan_id, d.jns_karyawan
						    FROM '.$this->_table.' a
						    LEFT OUTER JOIN '.$this->_table_other.' b ON a.divisi_id = b.divisi_id
						    LEFT OUTER JOIN '.$this->_table_other1.' c ON a.jabatan_id = c.jabatan_id
						    LEFT OUTER JOIN '.$this->_table_other2.' d ON a.status_karyawan_id = d.status_karyawan_id
						    WHERE 1 = 1 ';
		...
		$sql	.= ' ORDER BY a.nip DESC, a.nama DESC limit '.$p.' ,20';
	...
	public function count_karyawan($where_clausa=NULL){
